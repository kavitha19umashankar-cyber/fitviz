...
app = FastAPI(title="FitViz API", version="1.0.0")
...
@api_router.get("/")
async def root():
    return {"message": "Welcome to FitViz API"}
...
async def request_demo(input: DemoRequestCreate):
    ...
    _ = await db.demo_requests.insert_one(doc)
    return demo_obj
